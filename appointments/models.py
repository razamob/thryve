...
class Appointment(models.Model):
    ...
    delete_appointment_row = models.BooleanField(default=False, null=True)
    student_id = models.ForeignKey(
        StudentAccount, on_delete=models.CASCADE, null=True)
    staff_id = models.ForeignKey(
        StaffAccount, on_delete=models.CASCADE, null=True)
    cc_form = models.ForeignKey(
        CareerCounselorForm, on_delete=models.CASCADE, null=True)
    ec_form = models.ForeignKey(
        EmploymentConsultantForm, on_delete=models.CASCADE, null=True)
...
# This definition ensures that all StudentAccount objects are serialized before any Appointment objects. In turn,
>>>>>> > 5ee599be00a4af0c355663a9713312c83478cb1a

...
function drawChart(_data) {
    ...
    if (graph.value == 'area') {
        var chart = new google.visualization.AreaChart(document.getElementById('googlechartContainer'));
    }

    if (graph.value == 'line') {
        var chart = new google.visualization.LineChart(document.getElementById('googlechartContainer'));
    }
    // var chart = new google.visualization.ColumnChart(document.getElementById('googlechartContainer'));
